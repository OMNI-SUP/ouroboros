...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="google/gemini-2.5-pro-preview", allow_legacy_secret=True)
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="google/gemini-2.5-pro-preview", allow_legacy_secret=True)
...
os.environ["OUROBOROS_MODEL"] = str(MODEL_MAIN or "google/gemini-2.5-pro-preview")
os.environ["OUROBOROS_MODEL_CODE"] = str(MODEL_CODE or "google/gemini-2.5-pro-preview")
if MODEL_LIGHT:
